...
function ModalDeletar({atualizarTabela, id}) {
    ...
    async function remove() {
      ...
      const response = await veiculoMotor.removeVeiculosMotores(id)
      if(response.success){
        atualizarTabela()
        setIsOpen(false)
        toast.success('Motor excluido com sucesso', {
        ...
        <div>
            ...
            >
                ...
                <div className="text-center flex flex-col -mt-10">
                    ...
                    <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Tem certeza de que deseja excluir este motor?</h3>
                </div>
