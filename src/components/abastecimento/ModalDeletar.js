...
function ModalDeletar({atualizarTabela, id}) {
    ...
    async function remove() {
      try{
          const response = await abastecimento.removeAbastecimento(id)
          atualizarTabela()
      }
      catch(err){
          console.log(err);
        ...
        <div>
            ...
            >
                ...
                <div className="text-center flex flex-col -mt-10">
                    ...
                    <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Tem certeza de que deseja excluir este translado?</h3>
                </div>
