...
function ModalEditar({atualizarTabela, id}) {
  ...
  async function pegaAbastecimentoID() {
    try{
        const response = await abastecimento.getAbastecimentoID(id)
  ...
  async function atualizar(e) {
    e.preventDefault()
    try{
        const response = await abastecimento.updateAbastecimento(id, abastecimentos.descricao, abastecimentos.ativo)
